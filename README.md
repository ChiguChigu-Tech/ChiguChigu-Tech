...
# About Me :
東京電機大学大学院 理工学研究科 情報学専攻の修士課程2年です。
強化学習・意思決定・AIプロダクト開発に関心があり、研究と実装の両面から学んでいます。

### Research
現在は、報酬だけでなくコストや安全性、目標基準の充足を考慮する意思決定手法について研究しています。  
学部では、多腕バンディット問題を用いたマルチエージェント学習と、満足化に基づく意思決定手法を扱いました。

関心領域：
- Reinforcement Learning
- Safe / Constrained Decision Making
- Machine Learning
...
### Main :
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=python,javascript&theme=dark)

### In studying :
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=kotlin,aws,julia&perline=5&theme=dark)

### Basic :
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=c,cs,java,html,css,streamlit,arduino,vue&perline=5&theme=dark)
